...
export default function LandlordDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Calculate stats (these would typically come from backend endpoints)
      ...
      // Filter recent complaints (last 5) - ensure complaints is an array
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <Link href="/dashboard/tenants">
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-lg p-6 text-white cursor-pointer hover:shadow-xl transition-all">
            <div className="flex items-center justify-between">
              <div>
        ...
        <Link href="/dashboard/payments">
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg shadow-lg p-6 text-white cursor-pointer hover:shadow-xl transition-all">
            <div className="flex items-center justify-between">
              <div>
